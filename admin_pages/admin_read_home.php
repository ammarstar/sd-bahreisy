<div class="content">
  <div class="content_kiri">
    ...
    <table border="1">
      ...
      <?php
      $no=1;
      $query=mysqli_query($link, "SELECT * FROM utama");
      ...
      <tr>
        ...
        <td style="width:100px; text-align:center;" >
              <a href="./admin_index.php?edit_home= <?php echo $outputan['id'] ?>">Edit</a> ||
              <a href="./admin_index.php?delete_home= <?php echo $outputan['id'] ?>">Hapus</a>
        </td>

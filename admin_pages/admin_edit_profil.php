<?php
$id=$_GET['edit_profil'];
$query=mysqli_query($link, "SELECT * FROM tb_profil WHERE id='$id' ");
...
<div class="content">
  <div class="content_kiri">
    ...
    <tr><td><textarea rows="1" cols="60" style="resize:none;" name="i_judul_profil"><?php echo $outputan['judul'] ?> </textarea></td>
    </tr>
    <tr><td><h4>Content</h4></td>
    </tr>
    <tr><td>
        <textarea class="ckeditor" id="ckeditor" name="i_content_profil"><?php echo $outputan['isi'] ?></textarea>
    ...
    if(isset($_POST['i_simpan'])){
      $update=mysqli_query($link, "UPDATE tb_profil SET judul='".$_POST['i_judul_profil']."',
                                                            isi='".$_POST['i_content_profil']."' where id='$id'");

      if($update){
        echo "berhasil update";
        header("location:?rubah_profil");
      }
      else{
        echo "gagal update";
      }
